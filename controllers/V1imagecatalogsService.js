...
exports.getPublicsImageCatalogs = function(args, res, next) {
   ...
   **/
  var examples = {};
  examples['application/json'] = [{"name":"cloudbreak-default","url":"https://s3-eu-west-1.amazonaws.com/cloudbreak-info/v2-dev-cb-image-catalog.json","publicInAccount":true,"default":true}]
  /*[ {
  "publicInAccount" : true,
  "name" : "aeiou",
  "id" : 123456789,
